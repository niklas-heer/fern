...
/** Sleep for a finite duration. @param ms Duration in milliseconds, at most 3000. */
 ...
 * @param path Readiness file. @param leader_waits Whether the direct child pauses.
 */
 ...
 * @param argc Count. @param argv Fixture arguments. @return Status, or -1 for another mode.
 */
...
/** Execute one finite mode; all descendants expire even if supervision is broken.
 * @param argc Count. @param argv Fixture arguments. @return Explicit status or 90 on failed
 * assertion.
 */
