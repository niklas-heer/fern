...
`5b02ec61136eac8f07afc8a09817f702542fcc05`, including record and newtype `derive(Json)`.
Its native/WASM corpus covers 102 valid sources, 38 malformed cases with recovery
and 41 incremental edits. Actual-editor smoke tests open a derived newtype inside
a derived record and a codec call with clean diagnostics through discovery and explicit binary paths.
